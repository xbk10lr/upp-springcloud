...
public class ReqPlaceOrder {
	//商户号
	@NotNull(message="mernbr不能为空")
	private String mernbr;
	
	//商户交易流水号
	@NotNull(message="merseqnbr不能为空")
	private String merseqnbr;
	
	//商户交易时间
	@NotNull(message="mertranstime不能为空")
	private String mertranstime;
	
	//付款账户
	@NotNull(message="payeracctnbr不能为空")
	...
	//付款账户名
	@NotNull(message="payeracctname不能为空")
